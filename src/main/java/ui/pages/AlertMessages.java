...
public enum AlertMessages {
    ...
    TRANSFER_ERROR_NEGATIVE_VALUE_OLD("❌ Error: Transfer amount must be at least 0.01"),
    TRANSFER_ERROR_NEGATIVE_VALUE("Invalid transfer: insufficient funds or invalid accounts"),
    TRANSFER_ERROR_EXCEEDED_MAXIMUM_VALUE("Transfer amount cannot exceed 10000"),
