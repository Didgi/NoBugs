...
public class WireMockClient {
    ...
    public static WireMock setupMock(FraudCheckMock config) {
        return new WireMock(Config.getProperty("wire_mock_host"), Integer.parseInt(Config.getProperty("wire_mock_port")));
    }

    public static MappingBuilder buildResponse(String responseBody, int status) {
        return post(urlPathMatching(Config.getProperty("wire_mock_endpoint")))
